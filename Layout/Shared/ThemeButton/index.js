...
const useStyles = makeStyles((theme) => ({
  ...
  track: {
    ...
    '&:after': {
      background: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="12" width="12" viewBox="0 0 12 12"><rect width="12" height="12" rx="6" fill="${encodeURIComponent(
        theme.palette.getContrastText(theme.palette.text.secondary)
